...
<fieldset>
    ...
    <input type="text" id="titulo" name="titulo" placeholder="Titulo propiedad" value="<?php echo s($titulo); ?>">
    ...
    <input type="file" id="imagenes" name="imagenes" accept="image/jpeg, image/png">
        <?php if(isset($propiedad->Imagenes)): ?>
            <img src="/imagenes/<?php echo $propiedad->Imagenes ?>" class="imgSmall">
        <?php endif; ?>

    <label for="descripcion">Descripcion</label>
    <textarea id="descripcion" name="descripcion"><?php echo s($descripcion); ?></textarea>
</fieldset>
